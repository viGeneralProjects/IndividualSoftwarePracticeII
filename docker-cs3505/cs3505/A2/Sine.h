...
public:
    ...
    /// @param amplitudeInital Peak height of the sine wave
    /// @param wavelengthInital Distance (in degrees) between peaks
    /// @param angleIncrementInital How much the angle increases each step
    Sine(double amplitudeInital, double wavelengthInital, double angleIncrementInital);
